...
export default function TechStack() {
  return (
    <div className="relative w-full">
      ...
      >
        <div
          className={`absolute left-0 top-1/2 aspect-square w-full overflow-hidden rounded-full ${styles.techStackGradient2}`}
        >
        ...
        <div className={`relative aspect-square w-1/5 ${styles.rotate}`}>
          <div className={`${styles.techStack} h-full w-full rounded-full bg-aboutBg p-2`}>
            <img src="/assets/images/js2.svg" alt="" />
          </div>
          <div
            className={`${styles.techStack} absolute inset-0 h-full w-full translate-x-[150%] rounded-full bg-aboutBg p-2`}
          >
          ...
          <div
            className={`${styles.techStack} absolute inset-0 h-full w-full translate-x-3/4 translate-y-[130%] rounded-full bg-aboutBg p-2`}
          >
            <img src="/assets/images/nodejs2.svg" alt="" />
          </div>
          <div
            className={`${styles.techStack} absolute inset-0 h-full w-full -translate-y-[130%] translate-x-3/4 rounded-full bg-aboutBg p-2`}
          >
